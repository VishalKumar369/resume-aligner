            ...
            >
                ...
                <div className="flex justify-end gap-3">
                    ...
                    <button
                        ...
                        className="bg-error text-white text-sm px-4 py-2 rounded-xl transition-colors hover:bg-error/90 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
